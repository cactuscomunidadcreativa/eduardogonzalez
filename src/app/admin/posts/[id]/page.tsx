...
function emptyTranslation(locale: string): Translation {
  return { locale, title: "", excerpt: "", content: "", metaTitle: "", metaDesc: "" };
}
  ...
  async function handleAutoTranslate(targetLocale: string) {
    ...
    try {
      ...
      if (source.excerpt) {
        ...
        const data = await res.json();
        if (data.translated) {
          updateTranslation(targetLocale, "excerpt", data.translated);
        }
      }
      ...
      <div className="space-y-4">
        <div className="rounded-xl border border-gray-200 bg-white p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="mb-1 block text-sm text-gray-500">Extracto</label>
              <textarea
