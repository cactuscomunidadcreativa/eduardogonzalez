...
export default function EditBookPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    ...
    fetch(`/api/books/${id}`)
      ...
      .then((data) => {
        ...
        setPublishedYear(data.publishYear ?? "");
  ...
  async function handleSave() {
    ...
    const body = {
      ...
      publishYear: publishedYear === "" ? null : Number(publishedYear),
      buyUrl: buyUrl || null,
    ...
    <div>
      ...
      <div className="mb-8 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <h1 className="font-title text-2xl font-bold text-brand-blue">
            {id === "new" ? "Nuevo libro" : "Editar libro"}
          </h1>
        </div>
      ...
      <div className="mb-6 rounded-xl border border-gray-200 bg-white p-6">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div>
            <label className="mb-1 block text-sm text-gray-500">Imagen de portada (URL)</label>
            <input
              value={coverImage}
          ...
          <div>
            <label className="mb-1 block text-sm text-gray-500">Año de publicación</label>
            <input
              type="number"
              value={publishedYear}
          ...
          <div>
            <label className="mb-1 block text-sm text-gray-500">URL de compra</label>
            <input
              value={buyUrl}
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Escribe el contenido detallado del libro..."
                rows={12}
                className="w-full rounded-lg border border-gray-200 px-4 py-3 text-sm leading-relaxed outline-none focus:border-brand-orange"
              />
            </div>
